...
# ----------------------------
# 4. CFG Parsing (All Trees)
# ----------------------------
print("CFG Parsing (All Possible Trees):")
for tree in cfg_parser.parse(sentence):
    print(tree)
    tree.pretty_print()

# ----------------------------
# 5. PCFG Parsing (Best Tree)
# ----------------------------
print("\nPCFG Parsing (Most Probable Tree):")
